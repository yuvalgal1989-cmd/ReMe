    ...
    >
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">ReMe</h1>
          <p className="text-gray-500 text-sm mt-1">Never miss an important date</p>
        </div>

        <a
          href="/api/auth/google"
          className="flex items-center justify-center gap-3 w-full border border-gray-300 rounded-xl px-4 py-3 text-sm font-medium hover:bg-gray-50 transition-colors mb-4"
        >
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs text-gray-400 bg-white px-2">or quick start</div>
        </div>
        ...
        <form onSubmit={handleDevLogin} className="space-y-3">
          ...
          <button type="submit" className="btn-primary w-full justify-center" disabled={loading}>
            {loading ? 'Loading...' : 'Start without Google'}
          </button>
        </form>
      </div>
    </div>
